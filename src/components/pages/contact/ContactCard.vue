    ...
    <base-card :scrollan="scrollan" :class="big ? 'fullwidthcard' : null">
        <div class="contactcard" :class="big ? 'big' : null">
            <form class="contactform" @submit.prevent="sendEmail" v-if="!isLoading && !httpError">
                <div class="innertitlehide" :class="big ? 'titleshow' : null">
            ...
            <div class="logo" :class="big ? 'logobig' : null">
                ...
                <svg viewBox="0 0 149 184" class="o" :class="big ? 'obig' : null" ref="o" fill="none" xmlns="http://www.w3.org/2000/svg">
